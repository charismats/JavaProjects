...
public class MahasiswaDAO {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:1433;databaseName=universitas;integratedSecurity=true;trustServerCertificate=true;";
    ...
    public static void main(String[] args) {
        ...
        mDao.InsertRecords("A111", "Budi", 4, 4);
        //mDao.UpdateReocrds(25, "AAA", "Johny", 2, 3);
        mDao.ReadRecords();
        //mDao.DeleteRecord(25);
        //mDao.ReadRecords();
    }
}
